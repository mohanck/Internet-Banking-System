...
function func()
{
if(document.getElementById("upass").value == null)
{document.getElementById('op').innerHTML="<br><span style='font-family:Georgia'>Password field cannot be left blank"}
}
...
Please enable Javascript and try again.</h1>
	...
	<a class="show">
		<img src="images1/image_thumb13.png" alt="" width="600" height="300" title="" alt="" rel="<h3>I-Bank</h3>I-Bank offers almost any type of loans with minimum security to its Beloved and Valuable Customers."/>
	</a>
	
	<a >
		<img src="images1/home_loan.jpg" alt="" width="600" height="300" title="" alt="" rel="<h3>I-Bank</h3>I-Bank is offering Low Interest Home Loans for its Beloved and Valuable customers."/>
	</a>
	
	<a >
		<img src="images1/NPS.jpg" alt="" width="600" height="300" title="" alt="" rel="<h3>I-Bank</h3>I-Bank is offering Retirement Loans for the Adults of the Country at the time when they need it the most."/>
	</a>

	<a >
		<img src="images1/car_loans.jpg" alt="" width="600" height="300" title="" alt="" rel="<h3>I-Bank</h3>I-Bank offers its customers the chance of securing a car loan before heading to the local dealer and drive away with a great deal."/>
	</a>
	
	<a >
		<img src="images1/images_6.jpg" alt="" width="600" height="300" title="" alt="" rel="<h3>I-Bank</h3>I-Bank offers Personal Loans for its Beloved and Valuable customers."/>
	</a>
...
<div class="blue"><BR><BR>Enter Your Name and Password</div><BR> 
<TABLE align="center" width="300px"> 
<TR> 
 <TD style="text-align:center;"><span style="color:#660000;">Name</span></TD> <TD><input type="text" size="30" name="uname" id="nam" style="font-family:Comic Sans MS;" onblur="func();" onKeyPress="return disableCtrlKeyCombination(event);"
        onKeyDown="return disableCtrlKeyCombination(event);"/><TD/></TR> 
<TR><TD><span style="color:#660000">
Password </span></TD><TD><input type="password" size="30" name="upass" id="pass" style="font-family:Jokerman;" onKeyPress="return disableCtrlKeyCombination(event);"
        onKeyDown="return disableCtrlKeyCombination(event);" /><br /></TD></TR>
</TABLE>
...
<div class="hr grid_12 clearfix">&nbsp;</div>
		<!-- Footer -->
		 <p class="grid_12 footer clearfix">  
			...
			<!-- span class="float" style="position:absolute;right:120px"><b></span>-->
...
rs1=st.executeQuery("select * from SYSTEM.USLIST where uname='"+request.getParameter("uname")+"' and upass='"+request.getParameter("upass")+"'");
if(rs1.next()){
System.out.println("rs1 is not null and username and password is correct");
if(Integer.parseInt(rs1.getString(5))<=2){
...
ses.setAttribute("dname",rs1.getString(4));
...
if(Integer.parseInt(rs2.getString(5))<=2)
	{
st.execute("update SYSTEM.USLIST set status="+(Integer.parseInt(rs2.getString(5))+1)+" , unsuc='"+sqlToday+"'where uname='"+rs2.getString(2)+"'");
out.println("<script type='text/javascript'>document.getElementById('op').innerHTML=\"<br><span style='font-family:Georgia'>Entered Username/Password is wrong.<br>Your account may get Locked!!! </span>\";</script>");
}
...
out.println("<script type='text/javascript'>document.getElementById('op').innerHTML=\"<br><span style='font-family:Georgia'>Entered Username/Password is wrong.</span>\";</script>");
}
