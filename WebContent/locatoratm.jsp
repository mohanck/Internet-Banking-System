...
<div id="nav" style="font-family: Times New Roman">Bank 24/7 through a widespread network of various iBank ATMs making life easy and convenient for you.
User-friendly graphic screens makes ATM Banking with iBank a smoother experience.</div>
<%ses=request.getSession();%>
<br>
<marquee behavior="scroll" scrollamount="8" scrolldelay="150" bgcolor="#6083AD" style="border-color: #EEEEEE;"><img src="image/14868068_New_icons_blue.gif"/> <font color="#EEEEEE" style="font-family: Comic Sans MS;">  New ATM'S Being Opened on 11th July 2011 in Hyderabad,Mumbai,Delhi and other major cities  </font> <img src="image/14868068_New_icons_blue.gif"/></marquee>
<br><br>
 <center>
 To view the ATM's in particular city select the city and click Locate.<br><br> 
...
if(request.getParameter("sub")!=null&&request.getParameter("city")!=null){
	rs=st.executeQuery("select * from SYSTEM.LOC where city='"+request.getParameter("city")+"' and flag='A'");
	int i=0;%>
